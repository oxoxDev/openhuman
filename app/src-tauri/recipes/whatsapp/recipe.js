...
// `app/src-tauri/src/cdp_indexeddb/`. Browser notifications are handled by
// `notification_scanner` at the CDP level. This file is intentionally tiny:
// the recipe runtime only needs to confirm the page booted.
(function (api) {
  if (!api) return;
